...
class SoftMenu extends \yii\widgets\Menu
{
    /**
     * @inheritdoc
     */
    public $linkTemplate = '<a href="{url}">{icon} {label}  <span class="pull-right-container"> {count}</span></a>';
    ...
    public $defaultIconHtml = '<i class="fa fa-dashboard"></i> ';
...

    {
        ...
        if (isset($item['items'])) {
            ...
            $labelTemplate = '<a href="{url}">{icon} {label}   <span class="pull-right-container"> {count}<i class="fa fa-angle-left pull-right"></i></span></a>';

            $linkTemplate = '<a href="{url}">{icon} {label} <span class="pull-right-container">{count}<i class="fa fa-angle-left pull-right"></i></span></a>';
        ...
        $replacements = [
            ...
            '{count}' => empty($item['count']) ? '' : '<label class="label label-success">' . $item['count'] . '</label>',
